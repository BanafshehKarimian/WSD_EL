...
public class WordSenceDisambiguatorMain {
    ...
    public String main2(String inputString) {
        ...
        for (int i=0; i<tokens.size();i++){
            ...
            Integer index = maxScoreIndex.get(i);
            if (glosses.get(i).size()!=0 && +scores.get(i).size()!=0) {
                out = out +ids.get(i).get(index)+",";//'"'+ tokens.get(i) +'"'+":" +'"'+ glosses.get(i).get(index)+'"';
               // System.out.println("Word:" + tokens.get(i)+ids.get(i).get(index) +"_Score:" + scores.get(i).get(index)+"_selected gloss:" + glosses.get(i).get(index));
            }
            else {
                out = out  +"0,";//'"'+ tokens.get(i) +'"'+ ":"+"یافت نشد"+'"';
                //System.out.println("Word:" + tokens.get(i) + "_Score:None_selected gloss:None");
            }
            //out = out +",";
